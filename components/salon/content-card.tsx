...
export function ContentCard({
  ...
  const triggerEnabled =
    ...
    piece.stage === 'revision' ||
    piece.stage === 'aprobado'
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-3 p-3.5">
          ...
          {piece.autoGenerated && (
            <span className="flex w-fit items-center gap-1.5 rounded border border-primary/40 bg-primary/10 px-1.5 py-0.5 font-mono text-[9px] uppercase tracking-wider text-primary">
              <Zap className="size-2.5" aria-hidden="true" />
              Generado por disparador automático
            </span>
          )}
