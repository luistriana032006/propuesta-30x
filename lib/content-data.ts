...
export type TriggerKind = 'platform-variant' | 'ab-variants' | 'scheduled'
...
export const TRIGGERS: Trigger[] = [
  {
    id: 'tr1',
    name: 'Instagram aprobado → variante LinkedIn',
    description:
      'Al aprobar un post de Instagram, genera automáticamente una variante de copy adaptada para LinkedIn.',
  ...
  {
    id: 'tr2',
    name: 'Aprobación de programa → variantes A/B',
    description:
      'Al aprobar contenido de un programa, genera variantes de copy adicionales para testear cuál convierte mejor.',
    kind: 'ab-variants',
    active: true,
    runCount: 27,
  },
  {
    id: 'tr3',
    name: 'Borradores semanales por calendario',
    description:
      'Cada lunes, genera borradores para la semana según el calendario de eventos y cohortes activas.',
    kind: 'scheduled',
    active: false,
    runCount: 6,
  },
